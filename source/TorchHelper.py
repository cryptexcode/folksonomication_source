...
class TorchHelper:
    ...
    def checkpoint_model(self, model_to_save, optimizer_to_save, path_to_save, current_score, epoch, mode='max'):
        ...
        if ((np.max(self.checkpoint_history) == current_score and mode == 'max') or
            ...
            print('BEST saved', (max(self.checkpoint_history) == current_score and mode == 'max'),
                (min(self.checkpoint_history) == current_score and mode == 'min'))

        print('Current best', max(self.checkpoint_history), 'after {}th epoch', epoch)
